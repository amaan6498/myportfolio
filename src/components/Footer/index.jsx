    ...
    render(){
        return(
            <div className='footer'>
                <ul>
                    <li>
                        <a href='https://www.linkedin.com/in/amaanpeshimam' target='_blank' rel='noopener noreferrer' aria-label="LinkedIn">
                    ...
                    <li>
                        <a href='https://www.instagram.com/iam.aan07/' target='_blank' rel='noopener noreferrer' aria-label="LinkedIn">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                    ...
                    <li>
                        <a href="https://www.github.com/amaan6498" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" className="github-icon">
